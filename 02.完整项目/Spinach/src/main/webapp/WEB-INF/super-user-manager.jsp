                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="breadcrumb-holder">
                            <h1 class="main-title float-left">人员管理</h1>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-header">
                                <span class="pull-right"><button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal_add_user">
                                    <i class="fa fa-user-plus" aria-hidden="true"></i>添加新用户</button>
                                </span>
                                ...
                                <h3><i class="fa fa-user"></i> 用户列表 (总计:3名用户)</h3>
                            </div>
                            <!-- end card-header -->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <th>人员信息</th>
                                            <th style="width:130px">人员权限</th>
                                            <th style="width:150px">参与社团</th>
                                        ...
                                        <tr >
                                            ...
                                            <td>
                                                <span style="float: left; margin-right:10px;"><img alt="image" style="max-width:40px; height:auto;" src="static/assets/images/avatars/avatar3.png" /></span>
                                                <strong>曹鹏</strong>							<br />
                                                <small>caopeng3@tcl.com</small>
                                            </td>
